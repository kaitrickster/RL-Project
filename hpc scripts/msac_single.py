...
from spinup.algos.sac_pytorch.sac_multistep import sac_multistep as function_to_run ## here make sure you import correct function
import time
...
if __name__ == '__main__':
    ...
    settings = [['Ant-v2', 'Hopper-v2'],
		...
		[1000],
   		[5, 2, 8],
		[True]]
    whether_add_to_savename = [True, False, True, True, False]
    setting_savename_prefix = ['', '', 'ep', 'k-step', '']
